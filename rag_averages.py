...
def calculate_rag_average_correctness(file_path):
    """
    ...
    if total_count > 0:
        ...
        print(f"Accuracy for {file_path}: {average_correctness:.2f}%")
    else:
        print("No tasks to evaluate.")


# Call the function to determine accuracy
file_path = "gpt-4o-mini-RAG-2-19-2025-hw4.jsonl"
calculate_rag_average_correctness(file_path)

file_path = "llama-RAG-2-19-2025-hw4.jsonl"
calculate_rag_average_correctness(file_path)